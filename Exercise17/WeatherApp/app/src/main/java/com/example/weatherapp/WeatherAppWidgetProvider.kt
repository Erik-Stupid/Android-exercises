...
import com.example.weatherapp.MainActivity.Companion.API_ICON
import com.example.weatherapp.MainActivity.Companion.API_KEY
import com.example.weatherapp.MainActivity.Companion.API_LINK
...
class WeatherAppWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        ...
        appWidgetIds.forEach { appWidgetId ->
            ...
            loadWeatherForecast("Helsinki", context, views, appWidgetId, appWidgetManager)
